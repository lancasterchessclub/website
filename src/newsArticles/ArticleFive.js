  ...
  return (
    <div className={classes.container}>
      ...
      <Typography className={classes.article}>
          ...
          this comes as a dissapointment as we will miss out on a number of meets as well
          as the standard end of season lightning tournment, it's out of our hands. We look
          forward to the start of next season eagerly!<br/><br/>

          One small comfort is that the timing of this only occured after the
